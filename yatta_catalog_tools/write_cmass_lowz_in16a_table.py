...
f = open('16a_sdss_dr12_catalog.csv', 'r')
...
f = open('16a_sdss_dr12_catalog.csv', 'r')
grizy_inputs = np.genfromtxt(f, usecols=(17, 18, 19, 20, 21), dtype=int, delimiter=',', filling_values=0)
f.close()
...
f = open('16a_sdss_dr12_catalog.csv', 'r')
grizy = np.genfromtxt(f, usecols=(10, 11, 12, 13, 14), dtype=float, delimiter=',', filling_values=np.nan)
f.close()
...
f = open('hsc_16a_cmass_lowz.cat', 'w')
